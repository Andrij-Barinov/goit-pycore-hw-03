...
def normalize_phone(phone_number):
    ...
    # Remove all characters except digits and '+' from the incoming number
    sanitized = re.sub(r"[^\d+]", "", phone_number.strip())

    # Check if there is already a '+' at the beginning of the number
    if sanitized.startswith('+'):
        # Add '+38' if the number does not start with '+38'
        ...
        if sanitized.startswith('380'):
            sanitized = '+' + sanitized
        # Otherwise, add '+38' before the number
        else:

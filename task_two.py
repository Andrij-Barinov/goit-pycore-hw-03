...
# Entering data via input
min = int(input("Enter the minimum number in the set: "))
max = int(input("Enter the maximum number in the set: "))
quantity = int(input("Enter the number of numbers you want to select: "))

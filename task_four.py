...
def get_upcoming_birthdays(users):
    ...
    for user in users:
        ...
        # If the birthday already occurred this year, check next year
        ...
        if 0 <= days_diff <= 7:
            ...
            results.append({'name': name, 'congratulation_date': congratulation_date.strftime("%Y.%m.%d")})
    
    return results

# Example usage:
users = [
    {"name": "John Doe", "birthday": "1985.05.06"},
    {"name": "Jane Smith", "birthday": "1990.05.10"}
]
